\section{Conclusion}
  ...
  from \(50{,}495{,}818\) to \revmath{5{,}214{,}878} (\(9.68\times\)) and proving time
  from \(411.28\) s to \revmath{70.73} s (\revmath{5.81\times}). It also outperforms
  DualMatrix in proving time at every shared dimension, by \revmath{3.62\times} at
  \(k=2^{13}\).
  \end{revblock}
