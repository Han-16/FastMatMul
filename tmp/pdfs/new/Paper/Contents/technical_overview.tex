...
input-proximity challenges are derived.  After the challenges are fixed, the prover computes the intermediate
...
encoding checks.  Merkle openings authenticate the external Pedersen leaves,
and CP-Link binds those leaves to the sampled blocks used by the CP-SNARK.
