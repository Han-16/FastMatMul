...
and commitment generation.  For \(k=2^7\) and \(\rho=1/2\),
the codeword length is
\(n=256\), which is smaller than the required number of queries \(t=309\);
therefore, no measurement is reported for this parameter set.
