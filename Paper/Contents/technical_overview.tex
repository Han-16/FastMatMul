...
and provides auxiliary opening/linking material tying the wire handle to the
...
Merkle path validity and sampled-linking consistency over the public wire/leaf
handles are auxiliary verifier checks bound to the same transcript.
