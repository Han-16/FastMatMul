...
\begin{itemize}
    ...
    linear codes and Merkle-tree commitments.
	    In our sampled-opening backend, message commitments to
	    ...
	    the fold checks; auxiliary opening/linking verifiers connect those handles
	    to authenticated external leaves.
    ...
    $\epsilon_{\mathsf{SNARK}}$ is the SNARK soundness error,
	    ...
	    random-oracle loss $\epsilon_{\mathsf{FS}}(q_H)$.
		    ...
		    row-wise encoded matrices and to the sampled-opening backend,
