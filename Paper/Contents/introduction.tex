...
\begin{itemize}
    ...
    \begin{itemize}[nosep]
        ...
        ($420{,}197$ vs.\ $3{,}145{,}727$ constraints);
        Freivalds becomes infeasible at $k = 2{,}048$ while
        $\protocol$ scales to at least $k = 4{,}096$.

        \item \emph{Proving-time speedup.}
        $\protocol$ outperforms Freivalds for $k \geq 256$, achieving
        $2.8\times$ and $23.9\times$ speedups at
        $k = 512$ and $k = 1{,}024$ respectively.
        Beyond $k = 1{,}024$, Freivalds is infeasible; $\protocol$(KZG) proves
