...
The encoded intermediate vectors form a \(3\)-fold interleaved codeword.  For
...
\procedure[]{\protocol}{%
    ...
    \\
    \< \sendmessageleft*[1.3cm]{r} \<  r \sample \FF 
    \\
    ...
    \\ 
    \< \sendmessageleft*[1.3cm]{I, \alpha_x, \alpha_y, \alpha_z} \< \alpha_x,\alpha_y,\alpha_z\sample\mathbb{F}\setminus D 
    \\
