...
An anonymized artifact repository containing the implementation, benchmark
scripts, CSV results, and proof/evaluation materials is available at
\url{...}. The repository is frozen for review and contains instructions for
