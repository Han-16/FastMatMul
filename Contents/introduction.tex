...
distance \(\delta\), meaning that any two distinct codewords differ on at
least a \(\delta\)-fraction of their coordinates.  A proximity test uses a
small number of random coordinates to check whether a committed word is close
to some codeword, rather than reading the entire word.  We encode each matrix
row-wise and consider the Freivalds
